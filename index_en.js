...
$(document).ready(function () {
  ...
  for(var i=0;i<3;i++){
      ...
      $(".res"+Restorani[i].id).find(".tekst").append("<h4>"+Restorani[i].ime +  "</h4>"+"<span> Food type: " + Restorani[i].vrsta + " <br></span>"  
        + "<span> Location: "+ Restorani[i].lokacija+" <br></span>" + "<span> Rating: " + Restorani[i].mincena + "</span>"
     );
